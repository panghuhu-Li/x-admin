...
public class MybatisCodeGenerator {
    ...
    private static final String[] table = {"module_bid_tab", "Bid"};   // 必填，第一个是表名，第二个是实体类的名字
    private static final String modelName = "竞标";   // 必填

    //=========================================以上内容必填===================================================//

    static {
        // 必填
        ds.setUrl("jdbc:mysql://localhost:3306/" + schemaName + "?useUnicode=true&characterEncoding=utf-8&allowMultiQueries=true&useSSL=false&serverTimezone=Asia/Shanghai");
        ds.setUsername("root");
        ds.setPassword("xlfzxyc123");
    }
